...
const (
	BoonService_PerformHelloWorld_FullMethodName = "/messages.BoonService/PerformHelloWorld"
	BoonService_PlayRps_FullMethodName           = "/messages.BoonService/PlayRps"
)
...
func (c *boonServiceClient) PerformHelloWorld(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, BoonService_PerformHelloWorld_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *boonServiceClient) PlayRps(ctx context.Context, in *RpsChoice, opts ...grpc.CallOption) (*RpsResponse, error) {
	out := new(RpsResponse)
	err := c.cc.Invoke(ctx, BoonService_PlayRps_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BoonService_PerformHelloWorld_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BoonService_PerformHelloWorld_FullMethodName,
	}
...
func _BoonService_PlayRps_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BoonService_PlayRps_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var BoonService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/boondocks/messages/messages.proto",
}
