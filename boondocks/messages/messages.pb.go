...
type RpsScore struct {
	...
	UserWins string `protobuf:"bytes,1,opt,name=userWins,proto3" json:"userWins,omitempty"`
	CompWins string `protobuf:"bytes,2,opt,name=compWins,proto3" json:"compWins,omitempty"`
	Draws    string `protobuf:"bytes,3,opt,name=draws,proto3" json:"draws,omitempty"`
}

func (x *RpsScore) Reset() {
	*x = RpsScore{}
	if protoimpl.UnsafeEnabled {
...
func (x *RpsScore) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RpsScore) ProtoMessage() {}

func (x *RpsScore) ProtoReflect() protoreflect.Message {
	mi := &file_boondocks_messages_messages_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RpsScore.ProtoReflect.Descriptor instead.
func (*RpsScore) Descriptor() ([]byte, []int) {
	return file_boondocks_messages_messages_proto_rawDescGZIP(), []int{4}
}

func (x *RpsScore) GetUserWins() string {
	if x != nil {
		return x.UserWins
	}
	return ""
...
func (x *RpsScore) GetCompWins() string {
	if x != nil {
		return x.CompWins
	}
	return ""
...
func (x *RpsScore) GetDraws() string {
	if x != nil {
		return x.Draws
	}
	return ""
...
var file_boondocks_messages_messages_proto_rawDesc = []byte{
	...
	,
	...
	0x75, 0x72, 0x6e, 0x65, 0x79, 0x2f, 0x62, 0x6f, 0x6f, 0x6e, 0x64, 0x6f, 0x63, 0x6b, 0x73, 0x2f,
...
var file_boondocks_messages_messages_proto_goTypes = []interface{}{
	...
	(*RpsScore)(nil),      // 5: messages.RpsScore
}
var file_boondocks_messages_messages_proto_depIdxs = []int32{
	...
	5, // 3: messages.BoonService.PlayRps:output_type -> messages.RpsScore
